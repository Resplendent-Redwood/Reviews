...
ALTER TABLE `ReviewSummary` ADD CONSTRAINT `ReviewSummary_fk5` FOREIGN KEY (`PhotoURL`) REFERENCES ``(``);

ALTER TABLE `ProductCharacteristics` ADD CONSTRAINT `ProductCharacteristics_fk0` FOREIGN KEY (`ProductID`) REFERENCES `ReviewSummary`(`ProductID`);

ALTER TABLE `ProductCharacteristics` ADD CONSTRAINT `ProductCharacteristics_fk1` FOREIGN KEY (`CharacteristicID`) REFERENCES `Characteristics`(`CharacteristicID`);
